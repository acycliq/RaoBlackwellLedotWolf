function config() {
    return {
            ...
            cellData: 'https://api.github.com/repos/acycliq/LedoitWolf/contents/dashboard/data/ledoit_wolf/cellData?ref=main',
            geneData: 'https://api.github.com/repos/acycliq/LedoitWolf/contents/dashboard/data/ledoit_wolf/geneData?ref=main',
            // cellCoords: 'https://api.github.com/repos/acycliq/data_dump/contents/ca1_cell_2279/cellCoords?ref=master',
            cellEllipsoid: 'https://api.github.com/repos/acycliq/LedoitWolf/contents/dashboard/data/ledoit_wolf/cellEllipsoid?ref=main',
