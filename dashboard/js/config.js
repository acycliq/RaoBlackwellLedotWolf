function config() {
    return {
            ...
            cellData: 'https://api.github.com/repos/acycliq/RaoBlackwellLedotWolf/contents/dashboard/data/cellData?ref=main',
            geneData: 'https://api.github.com/repos/acycliq/RaoBlackwellLedotWolf/contents/dashboard/data/geneData?ref=main',
            // cellCoords: 'https://api.github.com/repos/acycliq/data_dump/contents/ca1_cell_2279/cellCoords?ref=master',
            cellEllipsoid: 'https://api.github.com/repos/acycliq/RaoBlackwellLedotWolf/contents/dashboard/data/cellEllipsoid?ref=main',
